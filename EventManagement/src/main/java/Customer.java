...
public class Customer {
    ...
    private static void listEvents(Connection connection) throws SQLException {
    ...
    private static void bookEvent(Connection connection, Scanner scanner) throws SQLException {
